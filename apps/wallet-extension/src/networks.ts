...
const ETH_SEPOLIA_NETWORK: ShieldedNetwork = {
  ...
  rpcUrl: env("VITE_RPC_URL") ?? "https://ethereum-sepolia-rpc.publicnode.com",
  explorerBaseUrl: "https://sepolia.etherscan.io",
  contracts: {
    poseidon: addr("VITE_POSEIDON_ADDRESS", "0xa9CC305Af95542673aea1518881B6F1E7A8DE3b8"),
    poseidonHasher: addr("VITE_POSEIDON_HASHER_ADDRESS", "0xE6d12EfF9db5FDb548Aa17Ad1587623FFAe3BE96"),
    verifier: addr("VITE_VERIFIER_ADDRESS", "0xf45A783A47c68570b9D786a291e934F6A6B70950"),
    merkleTree: addr("VITE_MERKLE_TREE_ADDRESS", "0x3C4A041C4145B7FEF8C341Ca10D162A717adcc7A"),
    pool: addr("VITE_POOL_ADDRESS", "0xDd10f44Bc04451f0e1B698F5a8422f56d0d05966"),
    token: addr("VITE_TOKEN_ADDRESS", "0x9DBEd8AB4A05b5E4b6aF3bf61AA3051F6caa91b4"),
  },
  poolDeployBlock: num("VITE_POOL_DEPLOY_BLOCK", 10744004),
  defaultPoolTokens: parsePoolTokensJson(env("VITE_ETH_SEPOLIA_POOL_TOKENS_JSON")).length
    ? parsePoolTokensJson(env("VITE_ETH_SEPOLIA_POOL_TOKENS_JSON"))
    : [
...
/** When `VITE_BASE_SEPOLIA_POOL_ADDRESS` matches this pool, unset contract env vars default to this public deploy. */
  ...
  BASE_SEPOLIA_POOL && ethers.isAddress(BASE_SEPOLIA_POOL)
    ? {
        ...
        contracts: {
          ...
          token: addr(
            "VITE_BASE_SEPOLIA_TOKEN_ADDRESS",
            baseSepoliaDeployedDefaults ? (BASE_SEPOLIA_DEPLOYED.token as `0x${string}`) : Z
          ),
        },
        poolDeployBlock: num(
          "VITE_BASE_SEPOLIA_POOL_DEPLOY_BLOCK",
          baseSepoliaDeployedDefaults ? BASE_SEPOLIA_DEPLOYED.poolDeployBlock : 0
        ),
        defaultPoolTokens: (() => {
          const parsed = parsePoolTokensJson(env("VITE_BASE_SEPOLIA_POOL_TOKENS_JSON"));
...
/** When `VITE_ARBITRUM_SEPOLIA_POOL_ADDRESS` matches this pool, unset contract env vars default to this public deploy. */
...
export function defaultShieldedChainId(): ShieldedChainId {
  const fromEnv = Number(env("VITE_DEFAULT_SHIELDED_CHAIN_ID"));
